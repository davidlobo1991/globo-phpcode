...
@section('main-content')
    <div class="container-fluid spark-screen" id="users">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box" id="userEdit">
                    ...
                    {!! Form::model($user, ['route' => ['users.update', $user->id], 'method' => 'PUT', 'id' => 'mainForm','v-on:submit.prevent' => 'validateBeforeSubmit']) !!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12 form-group clearfix">
                            <label for="showPassword">
                                {!! Form::checkbox('showPassword', null, false, ['class' => '', 'v-model' => 'showPassword']) !!}
                                Edit password?
                            </label>
                        </div>
                        <i class="clearfix"></i>
