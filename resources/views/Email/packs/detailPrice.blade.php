@if($reservation)
    <table width="900" border="0" cellspacing="0" cellpadding="0">
           <tr> 
           <td style="color: #fff;font-size: 18px;" colspan="2" align="center" bgcolor="#3729ff" style="color:#FFF"><h3>&emsp; {{ trans('common.final') }}   {{ trans('common.price') }}</h3></td>
          </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><b><span class="text-success"><b>{{ $reservation->getTotalPackPriceAttribute() }} </b>€</span></b></td>
            </tr>
