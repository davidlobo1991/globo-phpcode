                    ...
                    <div class="box-body">
                        ...
                        <div class="container-fluid spark-screen" id="reservations">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <a class="btn btn-default" href="{{ route('reservations-wristbands-pdf',$reservation->id ) }}" target="_blank"><i class="fa fa-file-pdf-o"></i> {{ trans('common.pdf') }}</a>
                                        ...
                                        <a href="{{ route('reservations-wristbands.edit',  $reservation->id) }}" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i> {{ trans('common.edit') }}</a>
                                ...
                                <div class="col-md-12">
                                    ...
                                    {{--@include('wristband::components.wristbandPassDetail')--}}
