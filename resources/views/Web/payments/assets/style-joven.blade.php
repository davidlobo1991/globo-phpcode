...
*/
    ...
    /* formulario usuarios */
    .c-cart-resume div.c-cart-resume__box {
        padding-bottom: 0; }
    ...
    form#form-cart input::-webkit-input-placeholder, form#form-cart textarea::-webkit-input-placeholder {
        color: #a1a1a1;
        font: 400 13.3333px Arial;
        text-transform: none; }

    form#form-cart input:-ms-input-placeholder, form#form-cart textarea:-ms-input-placeholder {
        color: #a1a1a1;
        font: 400 13.3333px Arial;
        text-transform: none; }

    form#form-cart input::placeholder, form#form-cart textarea::placeholder {
        color: #a1a1a1;
        font: 400 13.3333px Arial;
        text-transform: none; }
...
*/
    ...
    .paypal-button-tagline paypal-button-tagline-color-blue
</style>