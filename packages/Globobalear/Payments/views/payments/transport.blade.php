...
@if(isset($reservation->reservationTransports) && !empty($reservation->reservationTransports))
@if(!$reservation->reservationTransports->isEmpty())   
    ...
    <div class="panel-body">
            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                @foreach($reservation->reservationTransports as $bus)
                    <tr>
