    <div class="row text-center status">
        <div class="col-md-6 bg-green" style="padding-top: 10px;">
            <p><b>TOTAL:</b> <span id="total"></span> {{ $reservation->getTotalPackPriceAttribute() }}  €</p>
             <span id="toPay" data-pay="{{ $reservation->getTotalPackPriceAttribute() }}"></span>
        </div>
        <div class="col-md-6 bg-red" style="padding-top: 10px;">
            <p><b>REMAINING:</b> <span id="remainder"> {{$reservation->remainderToPayPack()}}</span>€ </p>
        </div>
    </div>
