            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box" id="showCreate">
                    <div class="box-header with-border">
                        <p class="lead">
                            {{ trans('common.create') }} @yield('contentheader_title')
                        </p>
                    ...
                    {!! Form::open(['route' => 'providers.store', 'id' => 'mainForm','v-on:submit.prevent' => 'validateBeforeSubmit', 'files' => true]) !!}
                        <div class="box-body">
                        ...
                        <div class="box-footer with-border">
                            <footer>
                                ...
                                <a class="btn btn-danger"
                                   href="{{ route('providers.index') }}">{{ trans('common.return') }}</a>
                            </footer>
                        </div>
                    {!! Form::close() !!}
