            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box" id="showCreate">
                    <div class="box-header with-border">
                        <p class="lead">{{ trans('common.price') }} @yield('contentheader_title')</p>
                    ...
                    {!! Form::open(['route' => ['products.pricesSave'], 'id' => 'mainForm','v-on:submit.prevent' => 'validateBeforeSubmit']) !!}
                    <div class="box-body">

                        @include('errors.errors')

                        @include('products::products.pricesTable')
