        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box" id="showCreate">
                    ...
                    {!! Form::open(['route' => 'wristband.store', 'id' => 'mainForm','v-on:submit.prevent' => 'validateBeforeSubmit']) !!}
                    <div class="box-body">
                    ...
                    <div class="box-footer with-border">
                        <footer>
                            ...
                            <a class="btn btn-danger" href="{{ route('wristband.index') }}">{{ trans('common.return') }}</a>
                        </footer>
                    </div>
                    {!! Form::close() !!}
