...
@section('main-content')
    <div class="container-fluid spark-screen" id="customers">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box" id="userEdit">
                    ...
                    {!! Form::model($customer, ['route' => ['customers.update', $customer->id], 'method' => 'PUT', 'id' => 'mainForm','v-on:submit.prevent' => 'validateBeforeSubmit']) !!}
                    ...
                    <div class="box-footer with-border">
                        <footer>
                            ...
                            <a class="btn btn-danger" href="{{ route('customers.index') }}">{{ trans('common.return') }}</a>
                        </footer>
                    </div>
                    {!! Form::close() !!}
